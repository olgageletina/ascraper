...
.. module:: artsy_scraper.py
   :synopsis: This scraper is designed to attain information on artworks featured on artsy.net. This script returns JSON records.

.. moduleauthor:: Olga Geletina
...
.. data:: CATEGORY_API_URL
    ...
    The API URL used as input for get_artworks_by_categories to scrape artwork information
    
.. data:: DEFAULT_CATEGORIES
    
    Enumerates various artwork categories, used as input for get_artworks_by_categories to scrape artwork information
"""
...
class HTTPException(Exception):
    """
    .. class:: HTTPException
        This exception is raised when there is a bad response that's other than unauthorized and not found.
...
class ArtsyScraper(object):
    ...
    def calculate_pages(self, num_results):
        """
        This method calculates the number of pages needed to retrieve the of number desired results.
